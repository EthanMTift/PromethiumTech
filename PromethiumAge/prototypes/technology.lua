...
local promethium_conduit_technology = {
    ...
    icon = "__PromethiumAge__/graphics/technology/promethium-conduit.png",
    icon_size = 2560,
    visible_when_disabled = true,
...
local promethium_heat_pipe_technology = {
  ...
  icon = "__PromethiumAge__/graphics/AquiloThermo.png",
  icon_size = 64,
  visible_when_disabled = true,
  effects = {
...
local promethium_drill_technology = {
    ...
    icon = "__PromethiumAge__/graphics/technology/promethium-drill.png",
    icon_size = 2560,
    visible_when_disabled = true,
...
local soilTechnology = {
    ...
    icons = {
        {
          icon = "__PromethiumAge__/graphics/promethium-soil.png",
          icon_size = 256,
        },
      },
