...
promethium_conduit_recipe.icon = "__PromethiumAge__/graphics/icons/promethium-conduit.png"
...
thawed_biter_egg.icon = "__PromethiumAge__/graphics/thawed-biter-egg.png"
...
local vulcanus_digging = {
    ...
    energy_required = 1,
    icon = "__PromethiumAge__/graphics/icons/tungsten-harvest-icon.png",
    ingredients = {
...
promethium_drill_recipe.icon = "__PromethiumAge__/graphics/icons/promethium-drill.png"
